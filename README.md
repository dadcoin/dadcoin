Dadcoin (DAD) - a 'faster' version of Litecoin which also uses scrypt
as a proof of work scheme and is intended for microtransactions.
 - 120 seconds block targets: beat that MinCoin! ;)
 - 1314 1314 000 total coins
...
So actually, this 'new' coin exists for the following reasons:
 - DAD proves that really anyone(!) can start a Litecoin/Bitcoin based currency
