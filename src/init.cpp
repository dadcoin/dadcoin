    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("SmallChange version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  dad [options]                     " + "\n" +
                  "  dad [options] <command> [params]  " + _("Send command to -server or dad") + "\n" +
                  "  dad [options] help                " + _("List commands") + "\n" +
                  "  dad [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "dad:"))
                fCommandLine = true;
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: dad.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: dad.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 6667 or testnet: 7777)") + "\n" +
...
//    }
    ...
    // Make sure only a single dad process is using the data directory.
    ...
    // requested to kill dad-qt during the last operation. If so, exit.
