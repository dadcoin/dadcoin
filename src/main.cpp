...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
   ...
   int64 nSubsidy = 1314 * COIN;
   int64 rewardChange = nHeight / 10;
   if(nHeight > 1000)
   {
   ...
   if(nHeight > 2500)
   {
   nSubsidy = nSubsidy * 0.8;
   }
   if(nHeight > 3500)
   {
   nSubsidy = nSubsidy * 0.7;
   }
   if(nHeight > 4500)
   {
...
nSubsidy = nSubsidy *0.1;
    ...
    if(nHeight < 111) // no block reward within the first 3 days
        nSubsidy = 1;
...
static const int64 nTargetTimespan = 0.2 * 24 * 60 * 60; // SmallChange: 0.2 days
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal dad miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xfec20ae34d8f42c33a205b801249558c389996952d09fcfbe696f23257d01f8e");
    }
