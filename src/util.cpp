...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "dad.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    {
        // Don't overwrite existing settings so command line settings override dad.conf
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "dad.pid"));
