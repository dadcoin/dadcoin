            ...
            if(newpass1 == newpass2)
            {
                if(model->setWalletEncrypted(true, newpass1))
                {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                                         tr("SmallChange will close now to finish the encryption process. Remember that encrypting your wallet cannot fully protect your dad from being stolen by malware infecting your computer."));
                    QApplication::quit();
                }
                else
                {
